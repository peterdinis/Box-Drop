            ...
            <Card className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Customize your interface colors</p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting('notifications', 'fileSharing', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Low storage warnings</p>
                  </div>
                </div>
                <Switch
                  checked={settings.notifications.storageAlerts}
                  onCheckedChange={(checked) => updateSetting('notifications', 'storageAlerts', checked)}
                />
              </div>
            </div>
          </TabsContent>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Allow file content search</p>
                  </div>
                </div>
                <Switch
                  checked={settings.privacy.fileIndexing}
                  onCheckedChange={(checked) => updateSetting('privacy', 'fileIndexing', checked)}
                />
              </div>
            </div>
          </TabsContent>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateSetting('storage', 'autoSync', checked)}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Cache files for offline use</p>
                  </div>
                </div>
                <Switch
                  checked={settings.storage.offlineAccess}
                  onCheckedChange={(checked) => updateSetting('storage', 'offlineAccess', checked)}
                />
              </div>
            </div>
