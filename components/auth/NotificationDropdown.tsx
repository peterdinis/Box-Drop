...
export default function NotificationDropdown() {
  ...
  useEffect(() => {
    // Pripojenie na socket.io server, uprav URL podľa tvojho backendu
    ...
    <div className="flex items-center justify-center font-sans">
      ...
      >
        ...
        <div className="p-3 border-t border-zinc-200 dark:border-zinc-700 text-center">
          <button
            onClick={() => alert("Open notification settings")}
            className="inline-flex items-center space-x-2 text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors"
          >
