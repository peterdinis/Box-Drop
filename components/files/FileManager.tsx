      ...
      <div className="border-b bg-card">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl font-semibold text-foreground">Cloud Chest</h1>
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <Button onClick={() => fileInputRef.current?.click()} className="gap-2 bg-gradient-primary">
                    ...
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {item.uploadDate.toLocaleDateString()} • {item.size ? formatFileSize(item.size) : 'Folder'}
                        </p>
                      </div>
                    </div>
