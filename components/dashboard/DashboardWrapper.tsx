...
const DashboardWrapper: FC = () => {
    ...
    const [shareModal, setShareModal] = useState<{ isOpen: boolean; fileName: string; fileType: string }>({
        isOpen: false,
        fileName: '',
        fileType: ''
    });
    ...
    const recentFiles = [
        ...
        { id: '2', name: 'Team Photo.jpg', type: 'image', size: '5.1 MB', modified: '1 day ago', starred: false },
        { id: '3', name: 'Budget 2024.xlsx', type: 'document', size: '1.2 MB', modified: '3 days ago', starred: true },
        { id: '4', name: 'Demo Video.mp4', type: 'video', size: '25.8 MB', modified: '1 week ago', starred: false }
    ];

    const quickActions = [
        { icon: <FileUploadModal />, label: 'Upload Files', color: 'text-blue-500', component: true },
        { icon: <CreateFolderModal />, label: 'New Folder', color: 'text-green-500', component: true },
        { icon: <Share2 className="w-5 h-5" />, label: 'Share', color: 'text-purple-500', component: false },
        { icon: <Star className="w-5 h-5" />, label: 'Starred', color: 'text-yellow-500', component: false }
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <FileShareModal
                ...
                onClose={() => setShareModal({ isOpen: false, fileName: '', fileType: '' })}
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        You have {recentFiles.length} recent files and {storageData.used} GB of storage used.
                                    </p>
                                </div>
                            ...
                            {quickActions.slice(2).map((action, index) => (
                                ...
                                >
                                    <div className="text-center">
                                        <div className={`${action.color} mb-3 flex justify-center group-hover:scale-110 transition-transform`}>
                                            {action.icon}
                                        </div>
                                        ...
                                        {viewMode === 'grid' ? (
                                            <div className="text-center">
                                                ...
                                                <div className="flex justify-center gap-1 mt-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                                    ...
                                                    <Button size="sm" variant="ghost">
                                                        <Star className={`w-3 h-3 ${file.starred ? 'fill-yellow-400 text-yellow-400' : ''}`} />
                                                    </Button>
                                                </div>
                                            </div>
                                        ) : (
                        ...
                        <Card className="p-6">
                            ...
                            <div className="space-y-3">
                                {teamMembers.slice(0, 4).map((member, index) => (
                                    <div key={member.id} className="flex items-center gap-3 animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
